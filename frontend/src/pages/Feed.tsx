...
const Feed = () => {
  ...
  return (
    <Container>
      ...
      {/* Feed Posts */}
      <div className="flex flex-col w-full min-w-[280px] sm:min-w-[320px] md:min-w-[400px] lg:min-w-[480px] xl:min-w-[560px] 2xl:min-w-[640px] max-w-full gap-8 sm:gap-10 md:gap-12 lg:gap-16 mt-2 bg-background min-h-screen pb-8">
