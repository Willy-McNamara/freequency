...
import { Avatar, Box, Card, CardHeader, Flex, Heading, Text, IconButton, CardBody, Image, CardFooter, Button, Badge } from "@chakra-ui/react";
...
const Post = ({post}: props) => {
  ...
  <CardBody pt="0">
  <Text p="0.5rem 0px 0.5rem" fontSize='xl'>{post.sessionTitle} | {post.sessionDuration} minutes</Text>
    <Text>
      {post.sessionNotes}
    </Text>
  </CardBody>
